...
if (isset($_REQUEST["btndelete"])) {
    try {
        $stmt_del = $obj->con1->prepare("delete from architect where id='" . $_REQUEST["u_id"] . "'");
...
<h4 class="fw-bold py-3 mb-4">Architect Master</h4>
...
<div class="card mb-4">
    <div class="row ms-2 me-3">
        <div class="col-md-6" style="margin:1%">
            <a class="btn btn-primary" href="#" onclick="javascript:adddata()" style="margin-right:15px;"><i class="bx bx-plus"></i>
                Add
                Architect</a>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    while ($city = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a
                                    href="javascript:editdata('<?php echo $city["id"] ?>','<?php echo base64_encode($city["name"]) ?>');"><i
...
<script type="text/javascript">
    function adddata() {
        eraseCookie("edit_id");
        eraseCookie("view_id");
        window.location = "architect_add.php";
    }
