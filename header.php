          ...
          <ul class="menu-inner py-1">
            ...
            <li
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "units.php" ? "active" : "" ?>">
                  <a href="units.php" class="menu-link">
                    <div data-i18n="course">Units</div>
                  </a>
                </li>
                <li class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "visitor.php" ? "active" : "" ?>">
                  <a href="visitor.php" class="menu-link">
                    <div data-i18n="course">Visitor</div>
                  </a>
                </li>
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "user.php" ? "active" : "" ?>">
