...
if(isset($_REQUEST["btndelete"]))
{
  try
  {
    $stmt_del = $obj->con1->prepare("delete from visitor where id='".$_REQUEST["v_id"]."'");
...
<h4 class="fw-bold py-3 mb-4">Visitor Master</h4>
            ...
            <div class="card mb-4">              
                <div class="row ms-2 me-3">
                    <div class="col-md-6" style="margin:1%">
                        <a class="btn btn-primary" href="#" onclick="javascript:adddata()"
                           style="margin-right:15px;"><i class="bx bx-plus"></i>  Add Visitor</a>
                  ...
                  <table class="table table-hover" id="table_id">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php 
                        $stmt_list = $obj->con1->prepare("SELECT * FROM `visitor`ORDER BY id DESC");
                        $stmt_list->execute();
                      ...
                      <tr>
                        ...
                        <a href="javascript:deletedata('<?php echo $res["id"]?>');"><i class="bx bx-trash me-1"></i> </a>
...
<script type="text/javascript">
    ...
    eraseCookie("edit_id");
    eraseCookie("view_id");
    window.location = "visitor_add.php";
}
